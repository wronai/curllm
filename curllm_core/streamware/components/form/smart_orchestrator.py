"""
Smart Form Orchestrator - LLM-driven form filling with verification.

Features:
- Field type validation (exclude file inputs from text mapping)
- Per-field verification after each fill
- Post-submit success evaluation with screenshot
- LLM-guided retry on failures
